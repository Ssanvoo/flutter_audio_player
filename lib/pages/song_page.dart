...
import 'package:flutter_audio_player/components/neu_box.dart';
import 'package:flutter_audio_player/models/playlist_provider.dart';
import 'package:provider/provider.dart';

/// Clase SongPage
///
/// `SongPage` es una pantalla que muestra la canción en reproducción con controles de
// reproducción.
...
/// - Se integra con `PlaylistProvider` para obtener la canción actual y controlar la
// reproducción.
class SongPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<PlaylistProvider>(
      // Consumer es un widget que escucha
      ...
      builder: (context, value, child) {
        ...
        return Scaffold(
          backgroundColor: Theme.of(
            context,
          ).colorScheme.surface, // Color de fondo
          body: SafeArea(
            // Asegura que el contenido no se superponga con la barra de
            // estado
            child: Padding(
