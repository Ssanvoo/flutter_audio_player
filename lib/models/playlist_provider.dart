...
// Lista de canciones en la playlist.
  final List<Song> _playlist = [
    ...
    // Canción 2
    Song(
      songName: "2 Of Amerikaz Most Wanted",
      artistName: "Tupac Shakur & Snoop Dogg",
      albumArtImagePath: "assets/images/2 Of Amerikaz Most Wanted.jpg",
      audioPath: "audio/2Pac-2-Of-Amerikaz-Most-Wanted-_feat.-Snoop-Dogg_-_E_.mp3",
    ),
    // Canción 3
    Song(
      songName: "Masones",
      artistName: "8Belial & Stiffy",
      albumArtImagePath: "assets/images/masones - 8belial.jpg",
      audioPath: "audio/8BELIAL-Masones.mp3",
    ),
  ];
...
// Setter para actualizar el índice de la canción actual.
  set currentSongIndex(int? newIndex) {
    ...
    // Notifica a los listeners (widgets que dependen de esta clase) que el estado ha
    // cambiado.
    notifyListeners();
  }
